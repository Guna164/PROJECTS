    ...
    while(video.isOpened()):
        ...
        if ret == True:
            ...
            if value >= 0.99:
                ...
                cv2.putText(frame, 'Gesture Recognize as : '+str(result), (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 255, 255), 2)
                if oldresult != result:
...
font = ('times', 20, 'bold')
title = Label(main, text='''                                     Hand Gesture Recognition Using Automatic Feature Extraction 
                                  and Deep Learning Algorithms with Memory''',anchor=W, justify=CENTER)
title.config(bg='#FBCEB1', fg='#660000')  
